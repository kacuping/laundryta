...
<body class="vertical-layout vertical-menu-modern  {{Auth::user()->theme == 1 ? 'dark-layout' : ''}} content-left-sidebar chat-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar" data-layout="dark-layout">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                          <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span>
                              <img class="round" src="{{asset(Auth::user()->foto == null ? 'backend/images/profile/avatar1.jpg' : 'storage/images/foto_profile/'. Auth::user()->foto )}}" alt="avatar" height="40" width="40">
                            </span>
                          </a>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">Redevelop &copy; 2020 - {{date('Y')}}<a class="text-bold-800 grey darken-2" href="#" target="_blank">luasbidang.com,</a>All rights Reserved</span><span class="float-md-right d-none d-md-block">Build With <i class="feather icon-heart pink"></i></span>
